  ...
  return (
    <div className="Table-controls">
      <div className="Table-controls__print-wrapper">
        ...
        <button className="Table-controls__btn-print Table-controls__btn-print_xls" onClick={props.onDownloadXlsx}></button>
      </div>

      <div className="Table-controls__search">
        <FormControl variant="standard" sx={{ m: 1, minWidth: 120 }}>
          <InputLabel id="demo-simple-select-standard-label">{props.translate("field")}</InputLabel>
          <Select
